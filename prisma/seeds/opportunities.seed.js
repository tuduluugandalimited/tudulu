...
exports.seedOpportunities = seedOpportunities;
...
const OPPORTUNITIES_DATA = [
    {
        ...
        description: "Funding for low-latency Health Information Systems (HIS), offline-first clinical tools, and Edge AI integrations tailored for East African health centers.",
        category: "HealthTech",
    ...
    },
    {
        ...
        description: "Subsidy program providing hybrid solar power systems, battery storage, and installation support for off-grid healthcare and education centers.",
    ...
    },
    {
        ...
        description: "Providing tournament management software, player stat tracking, and digital scouting directories to grassroots sports organizations.",
    ...
    },
    {
        ...
        description: "A 6-month hands-on fellowship focused on developing open-source APIs, public health data pipelines, and distributed connectivity solutions.",
...
function mapOpportunityType(type) {
    switch (type) {
        case "Grant":
            return client_1.OpportunityType.GRANT;
        case "Job":
            return client_1.OpportunityType.JOB;
        case "Scholarship":
            return client_1.OpportunityType.SCHOLARSHIP;
        case "Volunteer":
            return client_1.OpportunityType.VOLUNTEER;
        case "Tender":
            return client_1.OpportunityType.TENDER;
        default:
            return client_1.OpportunityType.GRANT;
    }
}
async function seedOpportunities(prisma) {
    ...
    if (!defaultOrg) {
        throw new Error("Default organization 'tudulu-uganda-limited' must be seeded before running opportunities seed.");
    }
    const defaultSector = await prisma.sector.findFirst();
    if (!defaultSector) {
        throw new Error("At least one sector must be seeded before running opportunities seed.");
    }
    ...
    console.log("All frontend opportunities successfully seeded into PostgreSQL database!");
}
//# sourceMappingURL=opportunities.seed.js.map