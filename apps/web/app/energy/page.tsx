// D:\tudulu\apps\web\app\energy\page.tsx

import Link from "next/link";

export const metadata = {
  title: "Energy Sector Intelligence & Grants | Tudulu",
  description:
    "Explore clean energy transitions, power infrastructure, renewable mini-grids, and electrification research across Africa.",
};
      ...
      <section className="bg-gradient-to-b from-[var(--td-bg-surface-elevated)] to-[var(--td-bg)] border-b border-[var(--td-border-subtle)] py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[var(--td-text)] mb-6 max-w-3xl">
            Powering Universal Access, Clean Energy Transitions, &
            Infrastructure Across Africa
          </h1>

          <p className="text-lg text-[var(--td-text-light)] max-w-2xl mb-8">
            Access targeted energy grants, renewable power financing, rural
            electrification initiatives, and grid modernization intelligence
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/opportunities?sector=energy"
            ...
            >
              Browse Energy Grants
            </Link>
            <Link
              href="/news?sector=energy"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[var(--td-bg-surface-elevated)] border border-[var(--td-border-subtle)] rounded-2xl p-6 sm:p-8 shadow-xs">
              ...
              <p className="text-[var(--td-text-light)] text-sm leading-relaxed mb-4">
                Reliable and affordable energy is the catalyst for
                industrialization, healthcare delivery, and educational
                equality. From decentralized solar mini-grids to geothermal
                expansion and regional power pools, Tudulu connects developers,
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[var(--td-color-primary)] to-[var(--td-color-secondary)] text-[var(--td-text-inverse)] rounded-2xl p-6 shadow-md">
              <h3 className="text-base font-bold mb-2">
                Are you an Energy Developer?
              </h3>
              <p className="text-xs text-white/90 mb-4 leading-relaxed">
                Publish power infrastructure tenders, list your clean tech
                enterprise, or showcase electrification milestones across the
                network.
              </p>
              <Link
                href="/contact"
