...
export const MOCK_ORGANIZATIONS: Organization[] = [
  ...
  {
    id: "who-africa",
    name: "World Health Organization Africa",
    acronym: "WHO AFRO",
    slug: "who-africa",
    description:
      "Regional office supporting public health systems, disease control, and emergency response across Africa.",
    website: "https://www.afro.who.int",
    region: "Pan-African",
    countriesServed: ["All African Countries"],
    headquarters: "Brazzaville, Republic of the Congo",
    organizationType: "UN Agency",
    continent: "Africa",
    coverage: "Pan-African",
    organizationSize: "Large",
    sectors: ["Health", "Emergency Response", "Research"],
    programs: ["Immunization", "Disease Surveillance", "Health Systems"],
    beneficiaries: ["Governments", "Hospitals", "Communities"],
    donors: ["UN"],
    partners: ["WHO Member States"],
    tags: ["Public Health", "Emergencies"],
    sdgs: [3],
    verificationLevel: "Verified",
    featured: true,
    metrics: {
    ...
    counts: { jobs: 18, grants: 8, events: 5, reports: 220, news: 150 },
  },
  {
    id: "unicef-uganda",
    name: "UNICEF Uganda",
    ...
    slug: "unicef-uganda",
    description:
      "Advancing child health, education, nutrition, and protection in Uganda.",
    website: "https://www.unicef.org/uganda",
    region: "East Africa",
    countriesServed: ["Uganda"],
    headquarters: "Kampala, Uganda",
    organizationType: "UN Agency",
    continent: "Africa",
    coverage: "National",
    organizationSize: "Large",
    sectors: ["Children", "Education", "Health", "Nutrition"],
    programs: ["Child Protection", "Basic Education", "Immunization"],
    beneficiaries: ["Children", "Women", "Schools"],
    donors: ["UN"],
    ...
    counts: { jobs: 8, grants: 4, events: 3, reports: 75, news: 50 },
  },
  {
    id: "living-goods",
    name: "Living Goods",
    slug: "living-goods",
    description:
      "Supporting community health workers with digital tools and last-mile healthcare delivery systems.",
    website: "https://livinggoods.org",
    region: "East Africa",
    countriesServed: ["Uganda", "Kenya"],
    headquarters: "Kampala, Uganda",
    organizationType: "International NGO",
    continent: "Africa",
    coverage: "Regional",
    organizationSize: "Medium",
    sectors: ["Digital Health", "Community Health", "Technology"],
    programs: ["Community Health Worker Support", "Digital Health"],
    beneficiaries: ["Health Workers", "Women", "Children"],
    donors: ["Gates Foundation", "USAID"],
    partners: ["Ministries of Health"],
    tags: ["Digital Health", "Community Health"],
    sdgs: [3],
    verificationLevel: "Verified",
    featured: false,
    metrics: {
    ...
    counts: { jobs: 4, grants: 5, events: 2, reports: 32, news: 20 },
  },
  {
    id: "brac-uganda",
    name: "BRAC Uganda",
    ...
    slug: "brac-uganda",
    description:
      "Delivering poverty reduction, youth empowerment, education, and livelihoods programs across Uganda.",
    ...
    coverage: "National",
    organizationSize: "Large",
    sectors: ["Education", "Youth Empowerment", "Economic Development"],
    programs: ["Empowerment and Livelihoods", "Education"],
    beneficiaries: ["Youth", "Women", "Rural Communities"],
    donors: ["Mastercard Foundation", "FCDO"],
    partners: ["Government of Uganda"],
    tags: ["Poverty Reduction", "Youth", "Women"],
    sdgs: [1, 4, 5, 8],
    verificationLevel: "Verified",
    featured: false,
    metrics: {
    ...
    counts: { jobs: 6, grants: 3, events: 2, reports: 28, news: 15 },
  },
  {
    id: "wateraid-nigeria",
    name: "WaterAid Nigeria",
    acronym: "WaterAid",
    slug: "wateraid-nigeria",
    description:
      "Improving access to safe water, sanitation, and hygiene services in underserved communities.",
    website: "https://www.wateraid.org/ng",
    region: "West Africa",
    countriesServed: ["Nigeria"],
    ...
    beneficiaries: ["Rural Communities", "Schools", "Women"],
    donors: ["FCDO", "EU"],
    partners: ["Government of Nigeria"],
    tags: ["WASH", "Sanitation", "Water"],
    sdgs: [3, 6],
    verificationLevel: "Verified",
    featured: false,
    metrics: {
    ...
    counts: { jobs: 3, grants: 2, events: 1, reports: 21, news: 12 },
  },
  {
    id: "action-against-hunger-nigeria",
    name: "Action Against Hunger Nigeria",
    acronym: "AAH",
    slug: "action-against-hunger-nigeria",
    description:
      "Addressing malnutrition, food insecurity, and humanitarian crises across Nigeria.",
    website: "https://www.actionagainsthunger.org",
    region: "West Africa",
    countriesServed: ["Nigeria"],
    headquarters: "Abuja, Nigeria",
    ...
    coverage: "National",
    organizationSize: "Large",
    sectors: ["Nutrition", "Humanitarian Aid", "Food Security"],
    programs: ["Nutrition", "Emergency Food"],
    beneficiaries: ["Children", "Women", "Refugees"],
    donors: ["EU", "UNICEF", "USAID"],
    partners: ["Government of Nigeria"],
    tags: ["Nutrition", "Food Security"],
    sdgs: [2, 3],
    verificationLevel: "Verified",
    featured: false,
    metrics: {
    ...
    counts: { jobs: 5, grants: 4, events: 2, reports: 44, news: 30 },
  },
  {
    id: "ghana-health-service",
    name: "Ghana Health Service",
    acronym: "GHS",
    slug: "ghana-health-service",
    description:
      "Government health agency responsible for public health service delivery in Ghana.",
    website: "https://ghs.gov.gh",
    region: "West Africa",
    countriesServed: ["Ghana"],
    headquarters: "Accra, Ghana",
    organizationType: "Government Agency",
    continent: "Africa",
    coverage: "National",
    organizationSize: "Large",
    sectors: ["Health", "Public Health"],
    programs: ["Public Health", "Health Services"],
    beneficiaries: ["Communities", "Hospitals"],
    donors: ["WHO", "Global Fund"],
    partners: ["Government of Ghana"],
    tags: ["Public Health", "Government"],
    sdgs: [3],
    ...
    counts: { jobs: 12, grants: 0, events: 1, reports: 60, news: 40 },
  },
  {
    id: "congo-basin-conservation",
    name: "Congo Basin Conservation Trust",
    slug: "congo-basin-conservation",
    description:
      "Protecting biodiversity, indigenous rights, and climate resilience in the Congo rainforest basin.",
    website: "https://example.org",
    region: "Central Africa",
    countriesServed: ["Democratic Republic of the Congo"],
    headquarters: "Kinshasa, DRC",
    organizationType: "Foundation",
    continent: "Africa",
    coverage: "Regional",
    organizationSize: "Medium",
    sectors: ["Environment", "Conservation", "Climate"],
    programs: ["Conservation", "Climate"],
    beneficiaries: ["Indigenous Communities", "Rural Communities"],
    donors: ["WWF", "EU"],
    partners: ["DRC Government"],
    ...
    counts: { jobs: 2, grants: 1, events: 0, reports: 14, news: 8 },
  },
  {
    id: "play-on-foundation",
    name: "PlayOn Foundation",
    slug: "play-on-foundation",
    logo: "https://images.unsplash.com/photo-1517649763962-0c623266cf10?w=120&auto=format&fit=crop&q=80",
    description:
      "Grassroots initiative leveraging team sports, mentorship, and socioeconomic programs to drive youth development, female leadership, and inclusion across Uganda.",
    mission:
      "To use team sports as a powerful tool for socioeconomic development, mentorship, and community leadership among youth.",
    foundedYear: 2020,
    ...
    programs: [
      "She Leads",
      "Hoops & Health",
      "Disability Sports for Inclusion",
      "Economic Empowerment Through Sport",
    ],
    beneficiaries: ["Youth", "Girls", "Persons with Disabilities"],
    sdgs: [3, 4, 5, 8, 10],
    donors: ["Local Partners", "Private Supporters"],
    partners: ["Schools", "Community Sports Hubs"],
    tags: [
    ...
    metrics: {
      ...
      countriesCount: 1,
      activeProjects: 6,
      beneficiariesReached: "5,000+",
      annualBudget: "$100K+",
    },
    counts: { jobs: 1, grants: 2, events: 4, reports: 5, news: 12 },
    website: "https://www.playon-foundation.org",
    email: "info@playon-foundation.org",
  },
  {
    id: "straight-talk-foundation",
    name: "Straight Talk Foundation",
    acronym: "STF",
    slug: "straight-talk-foundation",
    logo: "https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=120&auto=format&fit=crop&q=80",
    description:
      "Leading Ugandan communication-for-development NGO pioneering adolescent sexual and reproductive health communication, youth empowerment, and advocacy using multi-modal media.",
    mission:
      "Improving the sexual and reproductive health and well-being of young people through advocacy, evidence-driven communication initiatives, and youth-friendly services.",
    vision:
      "A world in which young people have access to sexual and reproductive health services and rights and live healthy and productive lives.",
    foundedYear: 1997,
    organizationType: "Local NGO",
    continent: "Africa",
    region: "East Africa",
    ...
    programs: [
      ...
      "Youth Livelihoods Support",
    ],
    beneficiaries: ["Youth", "Girls", "Students", "Health Workers"],
    sdgs: [3, 4, 5, 10],
    donors: ["Global Affairs Canada", "International Foundations"],
    partners: ["Ministry of Health", "Civil Society Networks", "UNICEF"],
    tags: [
      "SRHR",
      "AdolescentHealth",
  ...
  },
  {
    ...
    logo: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=120&auto=format&fit=crop&q=80",
    description:
      "Global humanitarian organization of the Seventh-day Adventist Church that delivers sustainable community development and disaster relief without regard to age, political affiliation, or ethnicity.",
    mission: "To serve humanity so all may live as God intended.",
    vision:
      "A professional, learning, and collaborating network transforming lives and communities.",
    foundedYear: 1956,
    organizationType: "Faith Based Organization (FBO)",
    continent: "Global",
    region: "Pan-African",
    ...
    programs: [
      ...
      "Clean Water & Community Hygiene",
    ],
    beneficiaries: ["Rural Communities", "Refugees", "Children", "Farmers"],
    sdgs: [1, 2, 3, 4, 6],
    donors: ["USAID", "WFP", "UNICEF", "ADRA Network"],
    partners: ["Local Government", "Faith-Based Networks"],
    tags: [
      "FaithBased",
      "HumanitarianRelief",
    ...
    counts: { jobs: 6, grants: 4, events: 2, reports: 18, news: 55 },
  ...
  },
  {
    ...
    slug: "afdb",
    description:
      "Financing infrastructure, energy, agriculture, and social development projects across Africa.",
    ...
    programs: ["Infrastructure", "Energy", "Agriculture"],
    beneficiaries: ["Governments", "Communities", "Businesses"],
    donors: ["Member Countries"],
    partners: ["African Union", "World Bank"],
    tags: ["Finance", "Development", "Infrastructure"],
    sdgs: [1, 2, 7, 8, 9],
    verificationLevel: "Verified",
    featured: true,
    metrics: {
    ...
    counts: { jobs: 25, grants: 12, events: 8, reports: 340, news: 200 },
  },
];
