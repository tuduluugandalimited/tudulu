...
export const MOCK_ORGANIZATIONS: Organization[] = [
  ...
  {
    id: "gould-family-foundation",
    name: "The Gould Family Foundation",
    slug: "gould-family-foundation",
    logo: "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?w=120&auto=format&fit=crop&q=80",
    description:
      "Private foundation dedicated to improving health outcomes for the poor and underserved by upgrading clinics and hospitals for women, newborns, and children in sub-Saharan Africa through professionalized biomedical engineering programs.",
    mission:
      "To improve health outcomes for the poor and underserved in sub-Saharan Africa.",
    foundedYear: 2007,
    organizationType: "Foundation",
    continent: "North America",
    region: "East Africa",
    countriesServed: ["Uganda", "Rwanda", "Burundi", "Kenya"],
    ...
    programs: [
      ...
      "Maternal and Newborn Healthcare Infrastructure Upgrade",
    ],
    beneficiaries: ["Health Workers", "Children", "Women", "Startups"],
    sdgs: [3, 9, 17],
    donors: ["Gould Family Foundation"],
    partners: [
      "St. Mary's Lacor Hospital",
      "Saint Kizito Matany Hospital",
    ...
    metrics: {
      ...
      countriesCount: 4,
      activeProjects: 25,
      beneficiariesReached: "500k+",
      annualBudget: "$5M+",
    },
    counts: { jobs: 2, grants: 3, events: 1, reports: 8, news: 15 },
    website: "https://www.gouldfamilyfoundation.com",
    email: "info@gouldfamilyfoundation.com",
  },
];
