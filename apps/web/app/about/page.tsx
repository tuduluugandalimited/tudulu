        ...
        <Section spacing="lg" className="py-20 sm:py-28 bg-[var(--td-bg)]">
          <Container size="md" className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                href="/contact"
                className="w-full sm:w-auto px-8 py-3.5 bg-[var(--td-color-primary)] hover:opacity-90 text-[var(--td-text-inverse)] font-semibold text-sm rounded-[var(--td-radius-md)] transition-all shadow-xs hover:shadow-md text-center"
              >
                Get in Touch
              </Link>
              <Link
                href="/opportunities"
                className="w-full sm:w-auto px-8 py-3.5 bg-[var(--td-bg-surface-elevated)] hover:bg-[var(--td-border-subtle)] text-[var(--td-text)] font-semibold text-sm rounded-[var(--td-radius-md)] transition-all text-center"
              >
                Browse Platform
              </Link>
            </div>
