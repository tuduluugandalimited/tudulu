...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchResourceCount = async (endpoint: string): Promise<number> => {
      try {
    ...
    Promise.all([
      fetchResourceCount("/api/v1/users"),
      fetchResourceCount("/api/v1/jobs"),
      fetchResourceCount("/api/v1/organizations"),
      fetchResourceCount("/api/v1/events"),
      fetchResourceCount("/api/v1/news"),
    ]).then(([usersCount, jobsCount, orgsCount, eventsCount, newsCount]) => {
      if (!isMounted) return;
      setStats({ usersCount, jobsCount, orgsCount, eventsCount, newsCount });
      setLoading(false);
    });
    ...
    <div className="min-h-screen bg-[var(--td-bg-soft)] text-[var(--td-text)]">
      <div className="max-w-6xl mx-auto space-y-8 py-10 px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-[var(--td-border-subtle)] pb-6">
          <div className="space-y-1">
            ...
            <p className="text-[var(--td-text-muted)] text-xs sm:text-sm">
              ...
              press releases, and system parameters.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-[var(--td-bg-surface-elevated)] border border-[var(--td-border-subtle)] shadow-lg flex items-center justify-between col-span-2 sm:col-span-1">
            <div className="space-y-1">
              <p className="text-xs font-medium text-[var(--td-text-muted)]">
                News Articles
              </p>
            ...
            <div className="p-3 rounded-xl bg-teal-500/10 border border-teal-500/20 text-teal-600 dark:text-teal-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="p-3 rounded-xl bg-teal-500/10 border border-teal-500/20 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Publish announcements, ecosystem press releases, and featured
                  story highlights.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Inspect user accounts, update administrative roles, or toggle
                  access permissions.
                </p>
              </div>
            </Link>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Manage platform subscribers, modify lists, and compose bulk
                  email dispatches.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Post, edit, curate, and review funding grants and career
                  opportunities.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Review partner organizations, non-profits, and ecosystem
                  networks.
                </p>
              </div>
            </Link>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="p-3 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Create, update, and remove platform events, webinars, and
                  workshops.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Curate community service placements and non-profit volunteer
                  roles.
                </p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[var(--td-text-muted)]">
                  Configure structural classifications and tagging parameters.
                </p>
              </div>
            </Link>
          </div>
