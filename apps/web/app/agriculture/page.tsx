// D:\tudulu\apps\web\app\agriculture\page.tsx

import Link from "next/link";

export const metadata = {
  title: "Agriculture Sector Intelligence & Grants | Tudulu",
  description:
    "Explore agricultural development initiatives, agribusiness grants, food security research, and farming innovations across Africa.",
};
      ...
      <section className="bg-gradient-to-b from-[var(--td-bg-surface-elevated)] to-[var(--td-bg)] border-b border-[var(--td-border-subtle)] py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[var(--td-text)] mb-6 max-w-3xl">
            Driving Sustainable Agriculture, Food Security, & Agribusiness
            Across Africa
          </h1>

          <p className="text-lg text-[var(--td-text-light)] max-w-2xl mb-8">
            Access targeted agricultural grants, active agribusiness networks,
            climate-smart farming research, and development news empowering
            rural economies and food value chains.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              Browse Agriculture Grants
            </Link>
            <Link
              href="/news?sector=agriculture"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[var(--td-bg-surface-elevated)] border border-[var(--td-border-subtle)] rounded-2xl p-6 sm:p-8 shadow-xs">
              ...
              <p className="text-[var(--td-text-light)] text-sm leading-relaxed mb-4">
                Agriculture remains the backbone of economic growth and food
                security across the continent. From climate-smart irrigation and
                value-addition supply chains to digital ag-tech platforms,
                Tudulu connects farmers, cooperatives, researchers, and global
                investors.
              </p>
            ...
            <div className="bg-[var(--td-bg-surface-elevated)] border border-[var(--td-border-subtle)] rounded-2xl p-6 sm:p-8 shadow-xs">
              <h3 className="text-lg font-bold mb-4 text-[var(--td-text)]">
                Explore Agriculture Sub-Sectors
              </h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[var(--td-color-primary)] to-[var(--td-color-secondary)] text-[var(--td-text-inverse)] rounded-2xl p-6 shadow-md">
              <h3 className="text-base font-bold mb-2">
                Are you an Ag Enterprise?
              </h3>
              <p className="text-xs text-white/90 mb-4 leading-relaxed">
                Publish funding calls, list your cooperative, or showcase food
                security initiatives to international stakeholders.
              </p>
              <Link
                href="/contact"
